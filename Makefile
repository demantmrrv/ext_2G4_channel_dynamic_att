...
SRCS:=src/channel_dynamic_att.c \
      src/channel_dynamic_att_args.c \
      src/channel_dynamic_att_com.c
...
LIB_NAME:=lib_2G4Channel_dynamic_att
A_LIBS:=
...
sub_system:
	$(MAKE) -C ext_2G4_channel_dynamic_att_client
